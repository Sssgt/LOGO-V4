...
if (iconMenu != null) {
  let delay = 500;
  let menuBody = document.querySelector(".header-bottom__menu");
...
if (document.querySelector('.slider__block')) {

  //Праоаметры слайдера
  new Swiper('.slider__block', { //указывается класс слайдера
    observer: true,
    observerParents: true,
    slidesPerView: 1, //кол-во показываемых слайдов
    spaceBetween: 10, // отступы меж слайдами
    watchOverflow: true,
    speed: 800, // скорость перелистывания слайда
    loop: false, // бесконечность слайда
    ...
    //стрелки навигации
    navigation: {
      nextEl: '.slider .slider-arrows__next',
      prevEl: '.slider .slider-arrows__prev',
    },
    //стрелки навигации
    pagination: {
      el: '.slider-arrows__numb',
      type: 'fraction',
    }
  });
}
